function plotConfusionMat(R,cmap,daglist)
...
for modID = 1:numel(daglist)
    R.out.dag = sprintf([R.out.tag '_M%.0f'],modID);
    load([R.path.rootn '\outputs\' R.path.projectn '\'  R.out.tag '\' daglist{i}'\modeProbs_' R.out.tag '_'  R.out.dag '.mat'])
